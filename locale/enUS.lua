...
L["DAMAGER_RED"] = E:WrapText(C.colors.red, _G.DAMAGER)
L["DELETE"] = _G.DELETE
L["DURABILITY_COLON"] = _G.DURABILITY .. ":"
L["ENABLE"] = _G.ENABLE
L["ENERGY"] = _G.ENERGY
L["ERROR_RED"] = E:WrapText(C.colors.red, _G.ERROR_CAPS)
...
L["HEALER_GREEN"] = E:WrapText(C.colors.green, _G.HEALER)
L["HIDE"] = _G.HIDE
...
L["TANK_BLUE"] = E:WrapText(C.colors.blue, _G.TANK)
L["TOTAL"] = _G.TOTAL
